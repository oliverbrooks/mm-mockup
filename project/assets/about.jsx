    ...
    <div style={{ background: "#fff", color: "#000" }}>
      ...
      <section className="wrap" style={{ padding: "96px 48px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
          {[
            { word: "Reveal", color: "var(--mm-orange)", copy: "Revealing the human stories and lived experiences of migration." },
            { word: "Remix", color: "var(--mm-blue)", copy: "Remixing stories, making them hyper-relevant to today." },
            { word: "Reframe", color: "var(--mm-violet)", copy: "Reframing people's perspective on migration — from 'us and them' to all of us." },
          ].map((m) => (
            <div key={m.word} style={{
              ...
              <div style={{ position: "absolute", top: -20, right: -20, opacity: 0.25 }}>
                <RemixingM size={180} color="#fff" interval={2200} seed={m.word.length}/>
              </div>
