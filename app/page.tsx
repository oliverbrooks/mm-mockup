...
function StoryCardLarge({ tag, tone, label, title, meta }: { tag: string; tone: string; label: string; title: string; meta: string }) {
  return (
...
function StoryCardSmall({ tag, tone, title, meta, label }: { tag: string; tone: string; title: string; meta: string; label: string }) {
  return (
    <a href="#" style={{ display: 'block' }}>
