/* Exhibition detail page — "All Our Stories" */
      ...
      <section style={{ padding: "40px 0 80px", borderBottom: "1.5px solid #000", background: "var(--mm-orange)", color: "#fff", position: "relative", overflow: "hidden" }}>
        ...
        <div className="wrap" style={{ position: "relative" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20, fontSize: 14 }}>
            <a href="index.html" style={{ opacity: 0.9 }}>Home</a>
            <span style={{ opacity: 0.5 }}>/</span>
            <a href="#" style={{ opacity: 0.9 }}>Exhibitions</a>
            <span style={{ opacity: 0.5 }}>/</span>
      ...
      <section className="wrap" style={{ padding: "48px 48px 96px", display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 64 }}>
        ...
        <aside>
          <div style={{ background: "var(--mm-paper)", padding: 32, borderRadius: 4, border: "1.5px solid #000" }}>
            ...
            <a href="visit.html" className="btn btn--ghost" style={{ marginTop: 20, width: "100%", justifyContent: "center" }}>Full accessibility guide →</a>
          </div>
