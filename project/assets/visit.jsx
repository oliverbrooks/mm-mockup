/* Visit page — focused on the 2028 permanent home at 65 Crutched Friars */
  ...
  return (
    <div style={{ background: "#fff", color: "#000" }}>
      ...
      <section style={{ padding: "64px 0 0", borderBottom: "1.5px solid #000" }}>
        ...
        {/* Big render / image band */}
        <div style={{ marginTop: 48, position: "relative" }}>
          <img src="assets/img/south-entrance.jpg" alt="Architect's render — Crutched Friars south entrance"
          ...
          }}>65 Crutched Friars · Render by the architects</div>
        </div>
      </section>
      ...
      <section className="wrap" style={{ padding: "96px 48px" }}>
        ...
        <h2 className="h-section" style={{ margin: "0 0 40px", maxWidth: 800 }}>
          Four floors. One migrating story.
        </h2>

        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          {[
            { tag: "Lower ground", title: "Auditorium & galleries", copy: "A flexible 200-seat auditorium at the heart of a 1,200 sq m journey through centuries of arrivals and departures.", img: "assets/img/auditorium.jpg", colour: "var(--mm-blue)" },
            { tag: "Ground floor", title: "Double-height lobby", copy: "A dramatic arrival space where rotating exhibitions, co-produced with contributors, meet you on the way in.", img: "assets/img/double-height.jpg", colour: "var(--mm-orange)" },
            { tag: "Street level", title: "South external entrance", copy: "Stepping out onto Crutched Friars — an accessible new threshold into the City.", img: "assets/img/south-entrance.jpg", colour: "var(--mm-green)" },
            { tag: "Courtyard + cafe", title: "Courtyard entrance", copy: "A courtyard entrance opening into a restaurant and shop featuring migration's impact on UK food & business.", img: "assets/img/courtyard-entrance.jpg", colour: "var(--mm-yellow)" },
          ].map((f, i) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: 64 }}>
          <div>
            ...
            <p className="lede" style={{ marginTop: 16, color: "var(--mm-grey)" }}>
              ...
              In the meantime, every current space and tour is built around the same commitments.
            </p>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            {[
